...
export default function NotFound() {
  return (
    <div className="flex w-full element justify-center items-center flex-col p-10 rounded-3xl">
     ...
     <p>با عرض پوزش، صفحه ای که به نظر می رسد به دنبال آن هستید، منتقل شده، هدایت شده یا برای همیشه حذف شده است.</p>
     <Link className='p-3 bg-blue-500/20 rounded-2xl mt-5 hover:bg-blue-500 hover:text-white' href="/">بازگشت به خانه</Link>
    </div>
  );
}