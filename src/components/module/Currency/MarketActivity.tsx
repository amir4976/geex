...
const MarketActivity = ({ chartData, chartDataSaccond }: props) => {
  ...
  const options: ApexOptions = {
    ...
    series: [
      { name: "سود شما", data: randomArray() },
      { name: "خرید ", data: randomArray() },
      { name: "محصول فروش", data: randomArray() },
    ],
    xaxis: {
    ...
    tooltip: {
      custom: ({ series, seriesIndex, dataPointIndex, w }) => {
        ...
        return `
        <div class="element" style="direction: rtl; text-align: right; padding: 10px; font-family: var(--font-peydaSemi); ">
  ...
  return (
    <div className="p-5 element rounded-3xl">
      <ReactApexChart
        options={options}
